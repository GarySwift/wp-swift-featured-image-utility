...
function get_featured_image($post_id=false) {
	...
	$sizes = array('letterbox', 'medium_large', 'fp-small', 'fp-medium', 'fp-large', 'fp-xlarge', 'featured-small', 'featured-medium', 'featured-large', 'featured-xlarge');// 'letterbox-medium', 
	
	$image=false;
	if ( has_post_thumbnail($post->ID) ) :
		// echo "<pre>Getting images</pre>";
 		$image = array(); 
		$post_thumbnail_id = get_post_thumbnail_id( $post );
